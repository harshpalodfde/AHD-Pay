...
import com.ahd.app.presentation.permissions.openAppDetailsSettings
...
private fun CameraScannerContent(
    ...
    Box(Modifier.fillMaxSize()) {
        ...
        // Small screen title, centered between the back chip and zoom chip
        // above. Sits at the same vertical rhythm as the top bar (same
        // statusBarsPadding + ~vertical center of the 12dp row padding)
        // without competing for space with either control.
        Row(
            Modifier
