package com.ahd.app.presentation.screens
...
import com.ahd.app.domain.FormField
import com.ahd.app.domain.OperationMode
import com.ahd.app.domain.SessionState
import com.ahd.app.presentation.PayUiState
import com.ahd.app.presentation.PayViewModel
import com.ahd.app.presentation.permissions.PermissionStatus
import com.ahd.app.presentation.permissions.openAccessibilitySettings
import com.ahd.app.presentation.permissions.openOverlaySettings
import com.ahd.app.presentation.permissions.rememberPermissionLaunchers
import com.ahd.app.presentation.ui.components.NeoPopAccentCard
import com.ahd.app.presentation.ui.components.NeoPopCard
import com.ahd.app.presentation.ui.components.NeoPopDangerOutlinedButton
import com.ahd.app.presentation.ui.components.NeoPopPrimaryButton
import com.ahd.app.presentation.ui.components.NeoPopSecondaryButton
import com.ahd.app.presentation.ui.components.NeoPopTextField
import com.ahd.app.presentation.ui.components.PinBoxes
import com.ahd.app.presentation.ui.components.StatusBanner
import com.ahd.app.presentation.ui.theme.NeoPopColors
import com.ahd.app.presentation.ui.theme.NeoPopType
...
fun PayScreen(
    ...
    Box(
        ...
        AnimatedVisibility(
            ...
            com.ahd.app.presentation.ui.components.MoneyRainOverlay(
...
private fun PayForm(
    ...
    Box(Modifier.fillMaxSize()) {
        Column(
            ...
            // ── Header: wordmark + "pay" label + history shortcut ──
...
/**
 * Reusable per-screen name wordmark — single-color accent text. Each of the
 * three main screens passes its own name via [text] (e.g. "Dipam" on Pay,
 * "Ankit" on Balance) so the header reads as a personalized name mark
 * instead of a fixed brand string.
 *
 ...
 */
@Composable
fun Wordmark(text: String = "AHD", modifier: Modifier = Modifier, onClick: (() -> Unit)? = null) {
    val view = LocalView.current
    val interactionSource = remember { MutableInteractionSource() }
    val isPressed by interactionSource.collectIsPressedAsState()
    val scale by animateFloatAsState(
...
private fun PermissionGate(
    permissions: PermissionStatus,
    mode: OperationMode,
    launchers: com.ahd.app.presentation.permissions.PermissionLaunchers,
